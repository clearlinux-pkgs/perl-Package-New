...
%prep
%setup -q -n Package-New-0.08
cd %{_builddir}/Package-New-0.08
...
cp %{_builddir}/Package-New-0.08/LICENSE %{buildroot}/usr/share/package-licenses/perl-Package-New/571205fab3219483856ac156c78539db74834e7e
if test -f Makefile.PL; then
